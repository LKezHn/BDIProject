...
-- Tue Dec  6 12:46:17 2020
-- Model: New BackupModel    Version: 1.0


-- -----------------------------------------------------
-- Base de datos

DROP DATABASE IF EXISTS BackupDrawings;
CREATE SCHEMA IF NOT EXISTS BackupDrawings CHARACTER SET utf8 ;
